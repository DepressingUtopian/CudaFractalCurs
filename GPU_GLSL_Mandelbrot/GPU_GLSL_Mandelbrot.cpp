// GPU_GLSL_Mandelbrot.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main(int argc, char *argv[])
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		if (itr < 200)
		{
			...
			iters << itr << endl;
			time << elapsed_time / 1000000000.0 << endl;
			itr++;
		}
	}
